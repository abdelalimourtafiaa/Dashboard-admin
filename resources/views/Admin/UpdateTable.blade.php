    ...
    <div class="container-scroller">
      ...
      @include('admin.navbar')
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            @endif
            <form action="{{ url('edite_table',$data->id_table) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group" style="padding: 15px">
                    <div class="row">
                        <div class="col">
                         <label for="countries" style="color: black;">Nom de table </label>
                         <input list="countries" value="{{$data->name}}" placeholder="Nom de table" style="background-color: #ffffff;color: black; border:none;" name="name" class="form-control" style="color: black">
